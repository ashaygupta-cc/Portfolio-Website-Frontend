...
const HeroSection: React.FC = () => {
    ...
    const shadows = isDark ? '0 10px 40px rgba(255, 69, 0, 0.4)' : '0 10px 40px rgba(139, 69, 19, 0.2)'

  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-light-main dark:bg-gradient-dark-main"
    >
      <Scene3D />
      
      <div className="absolute inset-0 overflow-hidden">
        {/* Light mode: subtle, peaceful elements (hidden in dark mode) */}
        <div className="absolute top-20 left-10 w-32 h-32 bg-light-crystal-blue rounded-full opacity-2 animate-float blur-xl dark:hidden" />
        <div className="absolute top-40 right-20 w-24 h-24 bg-light-crystal-purple rounded-full opacity-6 animate-float blur-lg dark:hidden" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-32 left-1/4 w-20 h-20 bg-light-crystal-blue rounded-full opacity-5 animate-float blur-md dark:hidden" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-20 right-1/3 w-28 h-28 bg-light-crystal-purple rounded-full opacity-5 animate-float blur-lg dark:hidden" style={{ animationDelay: '0.5s' }} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-screen">
          ...
          >
            ...
            >
              Full-Stack Developer, Machine Learning, Data-Science Enthusiast & Tech Entrepreneur passionate about creating
            ...
            >
              ...
              <div className="text-center">
                <div className="text-2xl font-light text-purple-600  dark:text-molten-gold mb-1 animate-fire-flicker">100%</div>
