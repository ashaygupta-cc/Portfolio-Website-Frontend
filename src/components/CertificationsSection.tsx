...
const CertificationsSection: React.FC = () => {
  ...
  const certifications = [
    ...
    /*,
    {
      ...
      issued: "July 2025",
      description:
        "Covers feature engineering, model validation, data leakage handling, and advanced ML techniques to improve model performance.",
    },
    {
      ...
      issued: "July 2025",
      description:
        "Explores clustering, recommender systems, and reinforcement learning to build intelligent, adaptive AI applications.",
    },
    {
      ...
      issued: "July 2025",
      description:
        "Deep dive into optimization methods, neural network architectures, and complex model training techniques for scalable AI.",
    },
    {
