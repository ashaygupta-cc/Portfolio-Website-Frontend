    ...
    >
      ...
      <div className="p-6">
        <motion.h3
          ...
          className="text-xl font-medium text-light-text dark:text-molten-gold mb-3 group-hover:text-light-crystal-purple dark:group-hover:text-inferno-orange transition-colors duration-300"
        >
          {title}
        </motion.h3>
