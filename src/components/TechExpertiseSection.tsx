...
const TechExpertiseSection: React.FC = () => {
  ...
  const detailedSkills = {
    ...
    softSkills : [ 
      { name: 'Problem Solving', icon: '💡', percentage: 100, barGradient: 'from-yellow-300 to-orange-400' },
      { name: 'Team Collaboration', icon: '🤝', percentage: 100, barGradient: 'from-yellow-300 to-orange-400' },
      { name: 'Communication', icon: '🗣️', percentage: 100, barGradient: 'from-yellow-300 to-orange-400' },
      { name: 'Project Management', icon: '📋', percentage: 100, barGradient: 'from-yellow-300 to-orange-400' },
      { name: 'Creativity', icon: '🎨', percentage: 100, barGradient: 'from-yellow-300 to-orange-400' },
      { name: 'Adaptability', icon: '🔄', percentage: 100, barGradient: 'from-yellow-300 to-orange-400' },
      { name: 'Leadership', icon: '👑', percentage: 100, barGradient: 'from-yellow-300 to-orange-400' },
      { name: 'Time Management', icon: '⏰', percentage: 100, barGradient: 'from-yellow-300 to-orange-400' },
      { name: 'Critical Thinking', icon: '🧠', percentage: 100, barGradient: 'from-yellow-300 to-orange-400' },
    ],
  };
