...
const TechExpertiseSection: React.FC = () => {
  ...
  const detailedSkills = {
     frontend: [
      { name: 'React.js', icon: '⚛️', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
      { name: 'JavaScript', icon: 'JS', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
      { name: 'HTML5', icon: '📄', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
      { name: 'CSS3', icon: '🎨', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
      { name: 'Tailwind CSS', icon: '💨', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
      { name: 'Responsive Design', icon: '📱', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
      { name: 'Next.js', icon: '⚡', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
      { name: 'Framer Motion', icon: '✨', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
    ],
    backend: [
      { name: 'Node.js', icon: '🟢', percentage: 100, barGradient: 'from-purple-400 to-pink-400' },
      { name: 'Express.js', icon: '🚀', percentage: 100, barGradient: 'from-purple-400 to-pink-400' },
      { name: 'Python', icon: '🐍', percentage: 100, barGradient: 'from-purple-400 to-pink-400' },
      { name: 'REST APIs', icon: '🔗', percentage: 100, barGradient: 'from-purple-400 to-pink-400' },
      { name: 'GraphQL', icon: '🌐', percentage: 100, barGradient: 'from-purple-400 to-pink-400' },
      { name: 'MongoDB', icon: '🍃', percentage: 100, barGradient: 'from-purple-400 to-pink-400' },
      { name: 'PostgreSQL', icon: '🐘', percentage: 100, barGradient: 'from-purple-400 to-pink-400' },
      { name: 'Firebase', icon: '🔥', percentage: 100, barGradient: 'from-purple-400 to-pink-400' },
    ],
    tools: [
      { name: 'Git & GitHub', icon: '🐙', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
      { name: 'VS Code', icon: '💻', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
      { name: 'Chrome DevTools', icon: '🔧', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
      { name: 'Figma', icon: '📐', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
      { name: 'Postman', icon: '📮', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
      { name: 'Vercel', icon: '▲', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
      { name: 'Netlify', icon: '🌐', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
      { name: 'Cloudinary', icon: '☁️', percentage: 100, barGradient: 'from-blue-300 to-purple-400' },
    ],
    softSkills : [ 
      { name: 'Problem Solving', icon: '💡', percentage: 100, barGradient: 'from-yellow-200 to-orange-400' },
      { name: 'Team Collaboration', icon: '🤝', percentage: 100, barGradient: 'from-yellow-200 to-orange-400' },
      { name: 'Communication', icon: '🗣️', percentage: 100, barGradient: 'from-yellow-200 to-orange-400' },
      { name: 'Project Management', icon: '📋', percentage: 100, barGradient: 'from-yellow-200 to-orange-400' },
      { name: 'Creativity', icon: '🎨', percentage: 100, barGradient: 'from-yellow-200 to-orange-400' },
      { name: 'Adaptability', icon: '🔄', percentage: 100, barGradient: 'from-yellow-200 to-orange-400' },
      { name: 'Leadership', icon: '👑', percentage: 100, barGradient: 'from-yellow-200 to-orange-400' },
      { name: 'Time Management', icon: '⏰', percentage: 100, barGradient: 'from-yellow-200 to-orange-400' },
      { name: 'Critical Thinking', icon: '🧠', percentage: 100, barGradient: 'from-yellow-200 to-orange-400' },
    ],
  };
