...
const TechExpertiseSection: React.FC = () => {
  ...
  const detailedSkills = {
    ...
    softSkills : [ 
      { name: 'Problem Solving', icon: '💡', percentage: 100, barGradient: 'from-yellow-200 to-orange-300' },
      { name: 'Team Collaboration', icon: '🤝', percentage: 100, barGradient: 'from-yellow-200 to-orange-300' },
      { name: 'Communication', icon: '🗣️', percentage: 100, barGradient: 'from-yellow-200 to-orange-300' },
      { name: 'Project Management', icon: '📋', percentage: 100, barGradient: 'from-yellow-200 to-orange-300' },
      { name: 'Creativity', icon: '🎨', percentage: 100, barGradient: 'from-yellow-200 to-orange-300' },
      { name: 'Adaptability', icon: '🔄', percentage: 100, barGradient: 'from-yellow-200 to-orange-300' },
      { name: 'Leadership', icon: '👑', percentage: 100, barGradient: 'from-yellow-200 to-orange-300' },
      { name: 'Time Management', icon: '⏰', percentage: 100, barGradient: 'from-yellow-200 to-orange-300' },
      { name: 'Critical Thinking', icon: '🧠', percentage: 100, barGradient: 'from-yellow-200 to-orange-300' },
    ],
  };
