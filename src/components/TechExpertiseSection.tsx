...
const TechExpertiseSection: React.FC = () => {
  ...
  const detailedSkills = {
    ...
    backend: [
      ...
      { name: 'Python', icon: '🐍', percentage: 90, barGradient: 'from-purple-400 to-pink-400' },
      { name: 'REST APIs', icon: '🔗', percentage: 100, barGradient: 'from-purple-400 to-pink-400' },
      { name: 'GraphQL', icon: '🌐', percentage: 90, barGradient: 'from-purple-400 to-pink-400' },
      { name: 'MongoDB', icon: '🍃', percentage: 100, barGradient: 'from-purple-400 to-pink-400' },
      { name: 'PostgreSQL', icon: '🐘', percentage: 90, barGradient: 'from-purple-400 to-pink-400' },
    ...
    tools: [
      ...
      { name: 'Chrome DevTools', icon: '🔧', percentage: 90, barGradient: 'from-blue-300 to-purple-400' },
      { name: 'Figma', icon: '📐', percentage: 95, barGradient: 'from-blue-300 to-purple-400' },
    ...
    softSkills : [ 
      ...
      { name: 'Communication', icon: '🗣️', percentage: 95, barGradient: 'from-yellow-200 to-orange-400' },
