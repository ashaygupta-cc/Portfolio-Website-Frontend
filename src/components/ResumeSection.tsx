...
const ResumeSection: React.FC = () => {
  const experiences = [
    {
      ...
      achievements: [
        'Built company from ground up to 2+ employees',
  ...
  return (
    <section id="resume" className="relative min-h-screen py-20 bg-gradient-light-main dark:bg-gradient-dark-main overflow-hidden">
