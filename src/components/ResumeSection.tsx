...
const ResumeSection: React.FC = () => {
  const experiences = [
    ...
    } /*,
    {
      ...
      period: '-',
      location: '-',
      description: 'Developed and maintained multiple web applications for various clients. Worked closely with design team to implement pixel-perfect UI/UX designs.',
      achievements: [
        'Delivered 2+ client projects on time',
        ...
        >
          <div className="bg-gradient-to-br from-light-crystal-blue/10 to-light-crystal-purple/10 dark:from-smoke-gray/50 dark:to-ashen-charcoal/50 border border-light-crystal-blue/50 dark:border-smoke-gray rounded-3xl p-12 max-w-4xl mx-auto">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center justify-center space-x-2 px-8 py-4 bg-gradient-to-r from-[#3a9fff] to-[#9a5fff] text-white font-medium rounded-full transition-all duration-300 hover:bg-blue-400 dark:bg-gradient-inferno dark:hover:shadow-fire-glow"
            >
