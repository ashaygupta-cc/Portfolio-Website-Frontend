...
import { MapPin, Star, Zap, Target, Rocket, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  const journeySteps = [
    {
      ...
      year: '2019',
      title: 'The Beginning',
      subtitle: 'First Steps into Tech',
      description: 'Started my journey as a junior developer, learning the fundamentals of web development and discovering my passion for creating digital solutions that make a difference.',
      image: 'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=600',
      icon: <Star className="w-6 h-6" />,
      position: 'left',
      achievements: ['Completed first web application', 'Learned React & Node.js', 'Joined development community']
    },
    {
      id: 2,
      year: '2020',
      ...
      description: 'Transitioned to full-stack development, working on complex projects and mentoring junior developers. This period shaped my understanding of scalable architecture.',
      image: 'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&cs=tinysrgb&w=600',
      icon: <Zap className="w-6 h-6" />,
      position: 'right',
      achievements: ['Led team of 8 developers', 'Reduced load time by 60%', 'Implemented CI/CD pipeline']
    },
    {
      id: 3,
      year: '2021',
      ...
      description: 'Became a senior full-stack developer, leading major projects and establishing coding standards. Focused on performance optimization and team development.',
      image: 'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=600',
      icon: <Target className="w-6 h-6" />,
      position: 'left',
      achievements: ['Delivered 20+ client projects', 'Improved code quality', 'Integrated payment systems']
    },
    {
      id: 4,
      year: '2022',
      title: 'Entrepreneurial Leap',
      subtitle: 'Founded Binary Beats',
      description: 'Took the bold step to start my own tech company, Binary Beats. Focused on creating innovative digital solutions and building a team of passionate developers.',
      image: BinaryBeats,
      icon: <Rocket className="w-6 h-6" />,
      position: 'right',
      achievements: ['Founded Binary Beats', 'Built team of 15+ employees', 'Achieved 100% client satisfaction']
    },
    {
      id: 5,
      year: '2023',
      title: 'Scaling Success',
      subtitle: 'Growing the Vision',
      description: 'Expanded Binary Beats operations, delivered 50+ successful projects, and established ourselves as a trusted partner for digital transformation.',
      image: 'https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&w=600',
      icon: <Star className="w-6 h-6" />,
      position: 'left',
      achievements: ['50+ projects delivered', 'Expanded to new markets', 'Industry recognition']
    },
    {
      id: 6,
      year: '2024',
      ...
      description: 'Currently focusing on AI integration, blockchain solutions, and next-generation web technologies. Building the future of digital experiences.',
      image: 'https://images.pexels.com/photos/3184244/pexels-photo-3184244.jpeg?auto=compress&cs=tinysrgb&w=600',
      icon: <Zap className="w-6 h-6" />,
      position: 'right',
      achievements: ['AI/ML integration', 'Blockchain development', 'Next-gen solutions']
    },
    // Additional journey steps
    {
      ...
      description: 'Completed my Computer Science degree with focus on software engineering and algorithms. Participated in hackathons and coding competitions.',
      image: 'https://images.pexels.com/photos/3184354/pexels-photo-3184354.jpeg?auto=compress&cs=tinysrgb&w=600',
      icon: <Star className="w-6 h-6" />,
      position: 'left',
      achievements: ['Graduated Magna Cum Laude', 'Won 3 hackathons', 'Published research paper']
    },
    {
      id: 8,
      year: '2017',
      ...
      description: 'Gained hands-on experience in software development at a local tech startup. Learned about agile methodologies and collaborative development.',
      image: 'https://images.pexels.com/photos/3184406/pexels-photo-3184406.jpeg?auto=compress&cs=tinysrgb&w=600',
      icon: <Target className="w-6 h-6" />,
      position: 'right',
      achievements: ['Built first production feature', 'Learned Git workflow', 'Mentored by senior developers']
    }
  ];

  const initialStepCount = 6;
  const sortedSteps = journeySteps.sort((a, b) => parseInt(b.year) - parseInt(a.year));
  const displayedSteps = showFullJourney ? sortedSteps : sortedSteps.slice(0, initialStepCount);

  return (
    <section id="journey" className="relative min-h-screen py-20 bg-gradient-light-main dark:bg-gradient-dark-main overflow-hidden">
                ...
                >
                    ...
                    >
                      ...
                      <div className="flex items-center mb-4">
                        ...
                        <div className="px-4 py-2 bg-gradient-to-r from-light-crystal-blue/10 to-light-crystal-purple/10 dark:from-smoke-gray/50 dark:to-ashen-charcoal/50 rounded-full">
                          <span className="text-light-crystal-purple dark:text-molten-gold font-medium text-sm">{step.year}</span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        {step.achievements.map((achievement, i) => (
                          <div key={i} className="flex items-start">
                            ...
                            <span className="text-light-muted dark:text-dark-text-muted text-sm font-light">{achievement}</span>
                          </div>
                        ))}
                      </div>
                    </motion.div>
                  ...
                  <div className="w-full lg:hidden pl-16 pr-4">
                    ...
                    >
                      ...
                      {/* Mobile Achievements */}
                      <div className="space-y-2">
                        <p className="text-xs font-medium text-light-muted dark:text-dark-text-muted mb-2">Key Achievements:</p>
                        {step.achievements.map((achievement, i) => (
                          <div key={i} className="flex items-center">
                            <div className="w-1.5 h-1.5 bg-light-crystal-blue dark:bg-inferno-orange rounded-full mr-2" />
                            <span className="text-light-muted dark:text-dark-text-muted text-xs font-light">{achievement}</span>
                          </div>
                        ))}
                      </div>
                    </motion.div>
                  ...
                  {/* Desktop Image side */}
                  <div className={`hidden lg:block w-5/12 ${step.position === 'left' ? 'pl-8' : 'pr-8'}`}>
                    <motion.div
                      whileHover={{ 
                        scale: 1.05,
                    ...
                    >
                      <div className="relative overflow-hidden rounded-3xl shadow-xl">
                        ...
                        <div className="absolute top-4 left-4 px-3 py-1 bg-white/90 dark:bg-ashen-charcoal backdrop-blur-sm rounded-full">
                          <span className="text-gray-800 dark:text-smoke-gray font-medium text-sm">{step.year}</span>
                        </div>
        ...
        >
          <div className="bg-gradient-to-br from-light-crystal-blue/10 to-light-crystal-purple/10 dark:from-smoke-gray/50 dark:to-ashen-charcoal/50 border border-light-crystal-blue/50 dark:border-smoke-gray rounded-3xl p-12 max-w-4xl mx-auto">
            ...
            <p className="text-light-muted dark:text-dark-text-muted mb-8 font-light max-w-2xl mx-auto leading-relaxed">
              This is just the beginning. I'm excited about the future of technology and 
              the endless possibilities ahead. Join me as we continue to innovate, create, 
